      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-gray-900 leading-tight">Sarah's Journey</h2>
          ...
          <div className="relative flex flex-col gap-5">
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div className="flex-1">
                ...
                <p className="font-bold text-gray-800 text-[15px]">Moving • Link Road, Bandra</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div className="flex-1">
                ...
                <p className="font-bold text-gray-800 text-[15px]">Safe Haven Hostels</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <div className="bg-blue-50/50 rounded-2xl p-3 px-4 flex flex-col justify-center items-center gap-1.5 border border-blue-100 min-w-[90px]">
            ...
            <span className="text-[11px] font-bold text-blue-800 uppercase tracking-wide">85%</span>
          </div>
          ...
          <button className="flex-1 bg-green-100/50 rounded-2xl p-3 flex flex-col justify-center items-center gap-1.5 border border-green-200 hover:bg-green-100 active:scale-95 transition-all shadow-sm">
            ...
            <span className="text-[11px] font-bold text-green-800 uppercase tracking-wide">Call User</span>
          </button>
